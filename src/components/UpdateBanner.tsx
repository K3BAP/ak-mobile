...
export function UpdateBanner({ show, onReload }: Props) {
  return (
    <AnimatePresence>
      {show && (
        <motion.div
          className="safe-top sticky top-0 z-40 flex items-center gap-3 border-b border-accent/30 bg-accent/15 px-4 py-3 text-sm font-medium text-accent backdrop-blur-xl"
